...
Compare results using the phase-locked PIV data, the SE data, and the POD-SE data.
[add comparison of pod modes?]
...
The global effects of excitation on shear layer development, both in general and in particular for LAFPAs, has been well-documented in the literature already (see Samimy \etal [Samimy2012] for a review on LAFPA excitation in jets).
